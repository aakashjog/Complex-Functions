...
\begin{solution}
	...
	\end{align*}
	by the \nameref{thm:Weierstrass_M-test}, $\zeta(z)$ converges in $\left\{ z : \Re(z) \ge 1 + \varepsilon \right\}$.
...
\begin{solution}
	...
	\end{align*}
	Therefore, by the \nameref{thm:Second_Uniqueness_Theorem},
	\begin{align*}
		f(z) & = g(z) \\
                     & = z
	\end{align*}
...
\begin{definition}[Characterization of isolated singular points]
	...
	Therefore, by \nameref{thm:Laurent_Theorem}, $f$ has a Laurent series around $z_0$ with $r = 0$, which converges in the ring $0 < |z - z_0| < R$.
	\begin{enumerate}
		\item
